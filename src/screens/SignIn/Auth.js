      ...
      <View style={{flex: 1}}>
        ...
        >
          ...
          <View style={{flex: 0, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 15}}>
            ...
            <Text style={{fontSize: 14, fontWeight: '400', color: '#FFFFFF', textAlign: 'center'}}>By creating or logging in to an account, you agree to our Terms & Conditions and Privacy Statement</Text>
          </View>
